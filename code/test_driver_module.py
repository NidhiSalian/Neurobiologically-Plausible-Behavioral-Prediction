...
x_train, x_test, y_train, y_test = model_selection.train_test_split(X_all_stshiseq,Y_all,test_size=0.1)
...
#downsampled = MaxPooling2D(pool_size=(2, 2), strides=None, padding='valid', data_format=None)
